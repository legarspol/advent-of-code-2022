...
//
        ...
        List<String> collect = Arrays.stream(fileString.split("\n")).filter(a -> !a.equals("")).sorted((a, b) -> compareLists(sToArray(a), sToArray(b))).collect(Collectors.toList());
        System.out.println(collect);
        System.out.println(collect.indexOf("[[2]]") + 1);
        System.out.println(collect.indexOf("[[6]]") + 1);
//        int score = 0;
